...
const APP_NAME = "Amazonas-Kipppunkt";
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Interaktive Sandbox zum Amazonas-Kipppunkt: kubische Doppelmulden-ODE aus amazon-utac, PRODES 0,17 %/Jahr gegen die alte 1-%-Modellannahme.",
      },
